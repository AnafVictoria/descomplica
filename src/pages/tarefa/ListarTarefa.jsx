...
function createData(
  ...
  return { idTarefa, tituloTarefa, descricaoTarefa, inicioTarefa,statusTarefa};
}

//Definição do array contendo os dados iniciais da listagem de tarefas
const initialRows = [
  createData(1, 'Tarefa 1', 'Passear com o cachorro', '2022-01-01', 'Concluída'),
  createData(2, 'Tarefa 2', 'Fazer Exerçicio', '2022-01-03',  'Em Andamento'),
